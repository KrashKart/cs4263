...
def run_case(name):
    ...
    if expected is None:
        ...
        pprint(expected)
    # To draw this case and your solution's own run with the project's visualiser, uncomment:
    from visualise_maze_board import visualise_maze_board
    print(visualise_maze_board(
        example_input=data,
